...
film_thick_var = np.linspace(1e-9,1,10000000)
...
#TF first
tf_area = 1.56e-4   #area of individual n and p module [m]
tf_area_var = np.linspace(1e-10,1e-4,10000000)
#tf_area = tf_area_var
...
Th_cond_i = (cond_thick)/(kappa[cond]*cond_area)  #Thermal resistance of conductor [K/W]
Th_cond = paradd(Th_cond_i,n_teg)
...
Th_Sl = (film_thick)/(kappa['film']*tf_area)
Th_Sl = paradd(Th_Sl,n_teg)   #Thermal resistance of an individual n or p module [K/W]
